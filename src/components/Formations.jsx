const Formations = () => {
  return (
    <div>
      ...
      <div>
        <div className="mt-8 mr-5 flex flex-col gap-3 w-full bg-grayBg p-3 border-1 border-border-white rounded-border-standard text-primary-white hover:scale-103 hover:border-neon-green transition-all hover:shadow-lg hover:shadow-green-500 ease-in-out">
          <div>
